...
export const RENBCH = new Token(1, '0x459086F2376525BdCebA5bDDA135e4E9d3FeF5bf', 8, 'renBCH', 'Ren Bitcoin Cash')
...
// VAREN
export const VAREN = new Token(ChainId.ETHEREUM, '0x72377f31e30a405282b522d588AEbbea202b4f23', 18, 'Varen', 'VRN')
