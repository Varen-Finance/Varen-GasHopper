...
import { OVERLAY_READY } from 'app/entities/FortmaticConnector'
        ...
        if (!window.web3 && !window.ethereum && option.mobile) {
          return (
            <Option
              ...
              header={option.name}
              subheader={null}
              icon={'https://varenx.com/images/wallets/' + option.iconName}
            />
          )
        }
        return null
          ...
          if (option.name === 'MetaMask') {
            return (
              <Option
                ...
                icon="https://varenx.com/images/wallets/metamask.png"
              />
            )
          } else {
      ...
      {error ? (
        ...
        <div className="flex flex-col w-full space-y-4">
          ...
          {walletView === WALLET_VIEWS.PENDING ? (
            ...
            <div className="grid grid-cols-2 gap-4 overflow-y-auto ">{options}</div>
          )}
