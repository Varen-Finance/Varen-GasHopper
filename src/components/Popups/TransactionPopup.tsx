...
import { getVarenExplorerLink } from '../../functions/explorer'
    ...
    <div className="flex flex-row w-full flex-nowrap" style={{ zIndex: 1000 }}>
      ...
      <div className="flex flex-col gap-1">
        <div
          ...
          style={{ maxWidth: '100%', whiteSpace: 'break-spaces', wordBreak: 'break-word' }}
        >
        ...
        {chainId && hash && (
          <ExternalLink
            ...
            href={getVarenExplorerLink(chainId, hash, 'transaction')}
          >
